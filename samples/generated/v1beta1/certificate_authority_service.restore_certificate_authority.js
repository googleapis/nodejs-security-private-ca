...
function main(name) {
  // [START privateca_restore_certificate_authority_sample]
  /**
  ...
  async function restoreCertificateAuthority() {
    // Construct request
    const request = {
      name,
    };
    ...
    // Run request
    const [operation] = await privatecaClient.restoreCertificateAuthority(
      request
    );
  ...
  // [END privateca_restore_certificate_authority_sample]
}
