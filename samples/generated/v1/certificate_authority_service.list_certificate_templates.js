...
function main(parent) {
  // [START privateca_v1_generated_CertificateAuthorityService_ListCertificateTemplates_async]
  /**
  ...
  async function listCertificateTemplates() {
    ...
    // Run request
    const iterable = await privatecaClient.listCertificateTemplatesAsync(
      request
    );
