...
function main(certificateRevocationList, updateMask) {
  // [START privateca_update_certificate_revocation_list_sample]
  /**
  ...
  const {CertificateAuthorityServiceClient} =
    require('@google-cloud/privateca').v1;
  ...
  async function updateCertificateRevocationList() {
    ...
    // Run request
    const [operation] = await privatecaClient.updateCertificateRevocationList(
      request
    );
  ...
  // [END privateca_update_certificate_revocation_list_sample]
}
