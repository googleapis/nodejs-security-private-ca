...
function main(parent) {
  // [START privateca_list_certificate_revocation_lists_sample]
  /**
  ...
  async function listCertificateRevocationLists() {
    // Construct request
    const request = {
      parent,
    };
  ...
  // [END privateca_list_certificate_revocation_lists_sample]
}
